...
\begin{figure}[t]
\centering
\includegraphics[width=\linewidth]{../paper_figures_600dpi/fig1_system_architecture_diagram.png}
\caption{Dual-Stream Semantic-Frequency Fusion Architecture (Proposed Model).}
\label{fig:arch}
\end{figure}
...
\caption{Comparative Receiver Operating Characteristic (ROC) Curves.}
\label{fig:roc}
\end{figure}

\begin{figure}[t]
\centering
\includegraphics[width=\linewidth]{../paper_figures_600dpi/fig6_cross_domain_dff_600dpi.png}
...
\caption{Controlled JPEG Compression Robustness Evaluation across Both Datasets ($Q=100$ to $Q=50$).}
